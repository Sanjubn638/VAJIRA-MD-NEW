...
global.owner = process.env.OWNER_NUMBER  || '94710513877' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || ' ' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94776928548,94702866541" : process.env.MODERATORS ,    
...
FOOTER: process.env.FOOTER || '‌⚙️ Mr.Sanjuwa Official 🍁 🇱🇰',    
